...
![1635817411804](https://tprzfbucket.oss-cn-beijing.aliyuncs.com/hadoop/202111/02/094333-703850.png)
...
![1635817532615](https://tprzfbucket.oss-cn-beijing.aliyuncs.com/hadoop/202111/02/094532-91013.png)HashLinkedList
...
![1635818597729](https://tprzfbucket.oss-cn-beijing.aliyuncs.com/hadoop/202111/02/100318-500876.png)
...
class DoubleList {
    ...
    // 在链表尾部添加节点 x，时间 O(1),双向链表使用的是尾插法
    public void addLast(Node x) {
        x.prev = tail.prev;
        x.next = tail;
        tail.prev.next = x;
