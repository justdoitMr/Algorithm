本文讲两道比较有技巧性的数据结构设计题，都是和随机读取元素相关的，前文 [随机算法之水塘抽样算法](http://mp.weixin.qq.com/s?__biz=MzAxODQxMDM0Mw==&mid=2247484974&idx=1&sn=795a33c338d4a5bd8d265bc7f9f63c03&chksm=9bd7f826aca07130e303d3d6f5c901b8aa00f9c3d02ffc26d45b56f1d36b538990c9eebd06a8&scene=21#wechat_redirect) 也写过类似的问题。
...
![1635660053929](https://tprzfbucket.oss-cn-beijing.aliyuncs.com/hadoop/202110/31/140055-293177.png)
...
**2、getRandom方法返回的元素必须等概率返回随机元素**，也就是说，如果集合里面有`n`个元素，每个元素被返回的概率必须是`1/n`。
...
class RandomizedSet {
    ...
    public boolean insert(int val) {
        ...
        // 在列表的末尾添加元素
        list.add(val);
        // hashmap中记录元素值记忆对应的索引
        // key对应的是值，value对应的是值的索引
...
![1635668104974](https://tprzfbucket.oss-cn-beijing.aliyuncs.com/hadoop/202110/31/161512-768058.png)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_jpg/gibkIz0MVqdHtClvtwf9tdwjhswkTHiaHuRI7oOGyyn3cic78JQEYUz5rbEdMPOAm51fdubicfZJdoz8yzKCYXZ8LA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_jpg/gibkIz0MVqdHtClvtwf9tdwjhswkTHiaHu5g1Eo29R8Jw0OrhLLEw3nR7gYjdMB9ZocoeHIhNQ7TyfalBuWkicoUQ/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
